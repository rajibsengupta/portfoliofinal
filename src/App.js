...
import {Carousel, Row, Col, Thumbnail, Image, Grid, Button, Modal, Badge, ControlLabel} from 'react-bootstrap';
import './App.css';
import slide1 from  './Assets/slide1.jpg'; import slide2 from './Assets/slide2.jpg'; import slide4 from './Assets/slide4.jpg';
import tools from './Assets/tools.png';
import maropost2 from './Assets/maropost2.png'; import comingsoon from './Assets/comingsoon.png'; import blockchain from './Assets/blockchain.png'; import crypto from './Assets/crypto.png';
import podcamp from './Assets/podcamp.png'; import carousel from './Assets/carousel.jpg'; import ethuoft from './Assets/ethuoft.png'; import royal from './Assets/royal.png'; import blockchain2 from './Assets/blockchain2.png'; import manymore from './Assets/manymore.jpg';
import carousel2 from './Assets/carousel2.jpg'; import carousel4 from './Assets/carousel4.jpg';
...
class App extends Component {
  ...
  render() {
   ...
   <div id="section0" className="container-fluid">
        ...
        <Row>
          <Carousel>
        <Carousel.Item>
          <img width={1200} height={300} alt="900x500" src={slide1} />
          <Carousel.Caption>
            <i>Our Moto</i>
        ...
        <Carousel.Item>
          <img width={1200} height={300} alt="900x500" src={slide2} />
          <Carousel.Caption>
            <i>Our Moto</i>
            <h2>I make heavenly UX come alive thus enabling greater wealth for U & I.</h2>
          </Carousel.Caption>
        ...
        <Carousel.Item>
          <img width={1200} height={300} alt="900x500" src={slide4} />
          <Carousel.Caption>
           <i>Our Moto</i>
            <h2>I make heavenly UX come alive thus enabling greater wealth for U & I.</h2>
          </Carousel.Caption>
  ...
  <div id="section2" className="container-fluid">
    ...
    <Grid>
      <Row>
      <Image src={tools} width={1100} height={700} responsive/>
      </Row>
    </Grid>
    </div>
  </div>
  ...
  <div id="section3" className="container-fluid">
    ...
    <Grid>
      <Row>
        <Col xs={12} md={3}>
            <Thumbnail style={{"maxWidth":"100%", "height": "500px"}} alt="171x180" src={maropost2} rounded="true">
        ...
        <Col xs={12} md={3}>
            <Thumbnail style={{"maxWidth":"100%", "height": "500px"}}  alt="171x180" src={comingsoon} rounded="true">
        ...
        <Col xs={12} md={3}>
            <Thumbnail style={{"maxWidth":"100%", "height": "500px"}} alt="171x180" src={blockchain} rounded="true" >
        ...
        <Col xs={12} md={3}>
            <Thumbnail style={{"maxWidth":"100%", "height": "500px"}} alt="171x180" src={crypto} rounded="true" >
    ...
    <div className="wrapper">
      <h1>How Do I Inspire <Badge>?</Badge></h1>
        <Grid>
          ...
          <Carousel>
          <Carousel.Item>
            <img width={1200} height={300} alt="900x500" src={podcamp} />
            <Carousel.Caption>
              <h2>PodCamp 2018</h2>
          ...
          <Carousel.Item>
            <img width={1200} height={300} alt="" src={carousel} />
            <Carousel.Caption>
          ...
          <Carousel.Item>
            <img width={1200} height={300} alt="900x500" src={ethuoft} />
            <Carousel.Caption>
              <h2>ETHUofT</h2>
          ...
          <Carousel.Item>
            <img width={1200} height={300} alt="900x500" src={royal} />
            <Carousel.Caption>
          ...
          <Carousel.Item>
            <img width={1200} height={300} alt="900x500" src={blockchain2} />
            <Carousel.Caption>
          ...
          <Carousel.Item>
            <img width={1200} height={300} alt="900x500" src={manymore} />
          </Carousel.Item>        
      </Carousel>
      </Row>
        </Grid>
      ...
      <Grid>
        ...
        <Carousel>
          ...
          <div className="container2">
            <img width={1200} height={500} alt="900x500" className="sillyvalley" src={carousel2} />
          ...
          <Carousel.Item>
            <img width={1200} height={500} alt="900x500" src={carousel4} />
            <Carousel.Caption>
              <h3>Presntations</h3>
            </Carousel.Caption>
          </Carousel.Item>
          <Carousel.Item>
            <img width={1200} height={500} alt="900x500" src={carousel} />
            <Carousel.Caption>
              <h3 >Articles/Blogs. Link Will be there</h3>
              <a href="https://medium.com/@tosfan4ever/my-current-product-design-portfolio-90d62377473">See Here</a>
            </Carousel.Caption>
          </Carousel.Item>
        </Carousel>
        </Row>
    ...
    <Grid>
      <Row>
        <Col xs={12} md={4} className="pro1">
         <Thumbnail>
            <Image style={{"marginLeft":"5px"}} src={profile} alt="242x200" circle/>
        ...
        <Row>
          <Col className="contacts" xs={12} md={8}>
            <form action="https://portfolio.us17.list-manage.com/subscribe/post?u=f9422a310acd554d2e1caa631&amp;id=c39a80176a" method="post" id="mc-embedded-subscribe-form" name="mc-embedded-subscribe-form" className="validate" target="_blank" novalidate>
              ...
              <input type="submit" value="Connect" name="subscribe" id="mc-embedded-subscribe" className="button btn btn-success"/>
            </form>
          </Col>
        </Row>
      </Grid>
